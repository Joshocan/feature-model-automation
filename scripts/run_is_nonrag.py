...
def main() -> None:
    ...
    ap.add_argument("--run-tag", default=os.getenv("FAME_RUN_ID", "is-nonrag"),
                    help="Run identifier passed through to output filenames (default: FAME_RUN_ID env or 'is-nonrag').")
    args = ap.parse_args()
